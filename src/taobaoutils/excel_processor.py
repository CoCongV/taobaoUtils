...
def send_request(target_url, payload): # Removed cookies parameter
    """
    向目标 URL 发送 POST 请求。
    ...
    # Add Cookie header logic directly here
    ...
    if appname_cookie and token_cookie:
        ...
        logger.info("已添加 Cookie 头: %s", headers['Cookie'])
    ...
    # Merging custom headers (existing logic)
